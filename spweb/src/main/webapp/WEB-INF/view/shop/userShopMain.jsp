...
.itm_foot_buyDisable{
 	background-image: url(img/CARD/etc/btn2_disable.png);
    margin-top: 6px;
    margin-left: 36px;
    width: 80px;
    height: 23px;
        		...
        		<c:choose>
        			<c:when test="${aList != null}">
            				...
            				<c:forEach items="${aList}" var="UserShopDTO">
            					...
            					<c:url var="content" value="userShopMain.do">
            			...
            			<nav>
            				<ul class="pagination">
            					<c:if test="${userShopPageDto.startPage > 1}">
            						<li class="page_item">
            							<a class="page-link" aria-label="Previous" href="userShopMain.do?currentPage=${userShopPageDto.startPage-userShopPageDto.blockPage}">
            					...
            					<c:forEach var="i" begin="${userShopPageDto.startPage}" end="${userShopPageDto.endPage}">
            						<c:url var="currPage" value="userShopMain.do">
								...
								<c:if test="${userShopPageDto.totalPage > userShopPageDto.endPage}">
									<li class="page_item">
										<a class="page-link" aria-label="Next" href="userShopMain.do?currentPage=${userShopPageDto.startPage+userShopPageDto.blockPage}">
