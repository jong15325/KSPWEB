...
public class GuildApplicationPageDTO {
	...
	public GuildApplicationPageDTO() {

	}
	
	public GuildApplicationPageDTO(int totalCount){
		  //총페이지수
				totalPage=totalCount/blockCount+(totalCount%blockCount==0?0:1);
	}

	public GuildApplicationPageDTO(int currentPage, int totalCount) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		
		//시작레코드
		startRow=(currentPage-1)*blockCount;
