        					...
        					<div id="tab-1" class="tab-pane active">
        						<div class="panel-body">
									<form name="insertFrm" id="insertFrm" method="post" enctype="multipart/form-data">
										<fieldset>
											<input class="form-control" type="hidden" value="3" name="article_category" id="article_category" />
	...
	<script>
    	$(document).ready(function(){
    		...
    		$('#btnList').bind('click', function() {
				$('#insertFrm').attr('action', 'updateBoardMain.do');
				$('#insertFrm').submit();
			});
    		...
    		$('#btnSave').bind('click', function() {
    			...
    			if($('#article_title').val().length < 1){
    				...
    				$('#insertFrm').attr('action', 'updateBoardInsertProcess.do');
    				$('#insertFrm').submit();
    			}
			});
