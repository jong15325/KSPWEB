                            		...
                            		<nav>
										<ul class="pagination">
											<c:if test="${messagePageDto.startPage > 1}">
												<li class="page_item">
													<a class="page-link" aria-label="Previous" href="mySendMessageSearch.do?currentPage=${messagePageDto.startPage-messagePageDto.blockPage}&option=${map.option}&keyword=${map.keyword}">
											...
											<c:forEach var="i" begin="${messagePageDto.startPage}" end="${messagePageDto.endPage}">
												<c:url var="currPage" value="mySendMessageSearch.do">
											...
											<c:if test="${messagePageDto.totalPage > messagePageDto.endPage}">
												<li class="page_item">
													<a class="page-link" aria-label="Next" href="mySendMessageSearch.do?currentPage=${messagePageDto.startPage+messagePageDto.blockPage}&option=${map.option}&keyword=${map.keyword}">
