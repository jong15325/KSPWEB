...
<script type="text/javascript">
	$(document).ready(function() {
		$('#messageSendList').bind('click', function() {
			location.href="mySendMessageBox.do";
		});
	});
</script>
<style>
     				...
     				<div class="col-lg-9 animated fadeInRight">
                		...
                		<div class="mail-box">
                        	...
                        	<div class="mail-body text-right tooltip-demo">
                           		<!-- <a href="mail_compose.html" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Reply"><i class="fa fa-reply"></i> 답장</a> -->
